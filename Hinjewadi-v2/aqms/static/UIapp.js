angular.module('myAppModule', [ 'ngRoute' ]).config(function($routeProvider) {
	...
	.otherwise({
		...
		function($scope) {
			...
			$scope.locations=[{"location":["Hinjewadi","1.1"]},{"location":["Kothrud","2.1"]},{"location":["Katraj","2.2"]},{"location":["Shivajinagar","1.2"]}
			,{"location":["Pashan","3.1"]}]
			//$scope.location_val
			...
			$scope.location = "1.1"
				$scope.locDict = {"1.1":"Hinjewadi", "1.2":"Shivajinagar", "2.1":"Kothrud", "2.2":"Katraj", "3.1":"Pashan"};
